...
function createWindow() {
  ...
  const icon = nativeImage.createFromPath(`${app.getAppPath()}/build/icon.jpeg`);
...
// O evento vai ser chamado aqui no arquivo main.js e algum procedimento pode ser realizado
